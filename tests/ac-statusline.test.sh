...
# The badge must accept the ATTRIBUTED form too. It is not exotic: the rooms-threads
...
# the captain to stop reading the one surface the rooms-threads skill needs at zero.
