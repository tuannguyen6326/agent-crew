...
if [ "$crewdeputy" = 0 ] && [ "$scout" = 0 ] && [ -z "$roomchief_family" ]; then
  ...
  # every branch that sets one (e.g. "yes (pinned on the backlog row)") - only
